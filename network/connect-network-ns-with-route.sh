...
runthis "ip -n ns-router addr add 192.168.1.1/24 dev veth-ns1-router"
runthis "ip -n ns-router addr add 192.168.2.1/24 dev veth-ns2-router"
echo ""

echo "Bring up the devieces..."
runthis "ip -n ns1 link set veth-ns1 up"
runthis "ip -n ns2 link set veth-ns2 up"
runthis "ip -n ns-router link set veth-ns1-router up"
runthis "ip -n ns-router link set veth-ns2-router up"
echo ""
